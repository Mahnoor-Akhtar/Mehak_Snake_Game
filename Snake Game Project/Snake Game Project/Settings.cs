...
Down
  ...
  internal class Settings
   ...
   public static int Speed { get; set; } //This is a public static int class called Speed
        ...
        public static int HighScore { get; set; } //This is a public static int class called HighScore
        ...
        public static GameState CurrentGameState { get; set; } //This is a public static GameState class
    ...
    public static Directions direction { get; set; } //This is a public static Directions class called direction
        ...
        {
    Width = 20; //This sets the Width value to 20 for better grid visibility
     Height = 20; //This sets the Height value to 20 for better grid visibility
   Speed = 10; //This sets the Speed value to 10
            Score = 0; //This sets the Score value to 0
            Points = 10; //This sets the Points value to 10
            GameOver = false; //This sets the GameOver value to false
        CurrentGameState = GameState.StartScreen; //This sets the game state to StartScreen
